...
module DiscourseChatbot
  module Topic
    class TopicTitleEmbeddingProcess < ::DiscourseChatbot::EmbeddingProcess
      def upsert(topic_id)
        if in_scope(topic_id)
          if !is_valid(topic_id)
            embedding_vector = get_embedding(topic_id)

            ::DiscourseChatbot::TopicTitleEmbedding.upsert(
              {
                topic_id: topic_id,
          ...
          topic_title_embedding =
            ::DiscourseChatbot::TopicTitleEmbedding.find_by(topic_id: topic_id)
