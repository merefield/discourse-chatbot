...
module ::DiscourseChatbot
  ...
  class OpenAIAgent < OpenAIBotBase
    ...
    def initialize
      ...
      user_location_distance_from_location_function = nil
      ...
      if defined?(Locations) == 'constant' && Locations.class == Module &&
         ...
         user_location_distance_from_location_function = ::DiscourseChatbot::ForumUserLocationDistanceFromLocationFunction.new
      end
      ...
      functions << user_location_distance_from_location_function if user_location_distance_from_location_function
