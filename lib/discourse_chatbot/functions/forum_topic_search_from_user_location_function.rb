      ...
      def parameters
        [
          ...
          },
          {
            ...
            description:
              I18n.t(
                "chatbot.prompt.function.forum_topic_search_from_user_location.parameters.number_of_users",
              ),
          },
        ]
      end
      ...
      def process(args)
        begin
          ...
          results.each_with_index do |result, index|
            ...
            response +=
              I18n.t(
                "chatbot.prompt.function.f0orum_topic_search_from_user_location.answer",
                title: topic.title,
