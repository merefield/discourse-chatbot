  ...
  class ForumUserLocationSearchFromUserFunction < Function
    ...
    def parameters
      [
        ...
        { name: "distance", type: String, description: I18n.t("chatbot.prompt.function.forum_user_search_from_user_location.parameters.distance") } ,
    ...
    def process(args)
      begin
        ...
        results.each_with_index do |result, index|
          ...
          distance = result.distance_from(target_user_location.to_coordinates, units: :km)
