        ...
        [
          {
            name: "query",
            type: String,
            description: I18n.t("chatbot.prompt.function.web_search.parameters.query"),
          },
        ]
      end
          ...
          if SiteSetting.chatbot_serp_api_key.blank?
            ...
            hash_results =
              ::GoogleSearch.new(
                ...
                serp_api_key: SiteSetting.chatbot_serp_api_key,
              ).get_hash

            result =
              hash_results.dig(:answer_box, :answer).presence ||
