...
module DiscourseChatbot
  module Functions
    class ForumTopicSearchFromLocationFunction < ::DiscourseChatbot::Function
      def name
        ...
        [
          {
            ...
            type: String,
            description:
              I18n.t("chatbot.prompt.function.forum_topic_search_from_location.parameters.coords"),
          },
          {
            name: "distance",
            type: String,
            description:
              I18n.t(
                "chatbot.prompt.function.forum_topic_search_from_location.parameters.distance",
              ),
          },
          {
            ...
            description:
              I18n.t(
                "chatbot.prompt.function.forum_topic_search_from_location.parameters.number_of_topics",
              ),
          },
        ]
      end
      ...
      def process(args)
        begin
          ...
          results =
            ::Locations::TopicLocationProcess.search_from_location(coords[0], coords[1], distance)

          response =
            I18n.t(
              "chatbot.prompt.function.forum_topic_search_from_location.answer_summary",
              distance: distance,
              query: query,
            )
          ...
          results.each_with_index do |result, index|
            ...
            response +=
              I18n.t(
                "chatbot.prompt.function.forum_topic_search_from_location.answer",
                title: topic.title,
        ...
        rescue StandardError
          {
            answer:
              I18n.t(
                "chatbot.prompt.function.forum_topic_search_from_location.error",
                query: args[parameters[0][:name]],
              ),
            token_usage: 0,
          }
