  ...
  module Tools
    class EscalateToStaff < ::DiscourseChatbot::Tool
        ...
        begin
          ...
          if !target_group_names.empty?
            ...
            default_opts = {
              ...
              raw:
                I18n.t("chatbot.prompt.function.escalate_to_staff.announcement", content: content),
          ...
          )
          {
            answer: {
              result:
                I18n.t("chatbot.prompt.function.escalate_to_staff.error", parameter: "unknown"),
              topic_ids_found: post ? [post.topic_id] : [],
              post_ids_found: [],
              non_post_urls_found: [],
            },
      ...
      def generate_escalation_title(opts)
        ...
        bot = ::DiscourseChatbot::Bot.new(opts, false)
        messages =
          prior_messages << {
            role: "user",
