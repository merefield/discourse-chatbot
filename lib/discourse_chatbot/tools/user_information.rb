  ...
  module Tools
    class UserInformation < ::DiscourseChatbot::Tool
      ...
      def description
        ...
        when "confirm"
          I18n.t(
            "chatbot.prompt.function.user_information.description.confirmation",
            user_field: @user_field,
          )
        else
          I18n.t(
            "chatbot.prompt.function.user_information.description.general",
            user_field: @user_field,
          )
        end
      end
          ...
          [
            {
              ...
              description:
                I18n.t(
                  "chatbot.prompt.function.user_information.parameters.answer.text",
                  user_field: @user_field,
                ),
            },
          ]
          ...
          [
            {
              ...
              description:
                I18n.t(
                  "chatbot.prompt.function.user_information.parameters.answer.confirmation",
                  user_field: @user_field,
                ),
            },
          ]
          ...
          [
            {
              name: "answer",
              type: String,
              enum: @user_field_options,
              description:
                I18n.t(
                  "chatbot.prompt.function.user_information.parameters.answer.dropdown",
                  user_field: @user_field,
        ...
        begin
          ...
          if ucf
            ...
            ::UserCustomField.create!(
              user_id: @user_id,
              name: @user_custom_field_name,
              value: args[parameters[0][:name]],
            )
          end
          ...
          Rails.logger.error(
            "Chatbot: Error occurred while attempting to store answer in a User Custom Field: #{e.message}",
          )
          {
            answer:
              I18n.t(
                "chatbot.prompt.function.user_information.error",
                user_field: @user_field,
                answer: args[parameters[0][:name]],
              ),
            token_usage: 0,
          }
        end
