...
module DiscourseChatbot
  module Post
    class PostReplyCreator < ::DiscourseChatbot::ReplyCreator
      ...
      def create
        ...
        begin
          ...
          if @is_private_msg && !@blocked_question &&
               SiteSetting.chatbot_private_message_auto_title && new_post.topic.posts_count < 10
