...
module Langchain
 ...
 # Rails.autoload_under "langchain" do
    ...
    require_relative "langchain/loader"
    require_relative "langchain/data"
    require_relative "langchain/conversation"
    # require_relative "langchain/dependency_helper"
    require_relative "langchain/contextual_logger"
  #end
  ...
  module Chunker
    ...
    require_relative "langchain/chunker/base"
    require_relative "langchain/chunker/text"
  end
  ...
  module Tool
    ...
    require_relative "langchain/tool/base"
    require_relative "langchain/tool/calculator"
    require_relative "langchain/tool/ruby_code_interpreter"
    require_relative "langchain/tool/google_search"
    require_relative "langchain/tool/weather"
    require_relative "langchain/tool/wikipedia"
    require_relative "langchain/tool/database"
  end
  ...
  module Processors
    ...
    require_relative "langchain/processors/base"
    require_relative "langchain/processors/csv"
    require_relative "langchain/processors/docx"
    require_relative "langchain/processors/html"
    require_relative "langchain/processors/json"
    require_relative "langchain/processors/jsonl"
    require_relative "langchain/processors/pdf"
    require_relative "langchain/processors/text"
    require_relative "langchain/processors/xlsx"
  end
  ...
  module Vectorsearch
    ...
    require_relative "langchain/vectorsearch/base"
    require_relative "langchain/vectorsearch/chroma"
    require_relative "langchain/vectorsearch/hnswlib"
    require_relative "langchain/vectorsearch/milvus"
    require_relative "langchain/vectorsearch/pinecone"
    require_relative "langchain/vectorsearch/pgvector"
    require_relative "langchain/vectorsearch/qdrant"
    require_relative "langchain/vectorsearch/weaviate"
  end
  ...
  module LLM
    ...
    require_relative "langchain/llm/base"
    require_relative "langchain/llm/ai21"
    require_relative "langchain/llm/cohere"
    require_relative "langchain/llm/google_palm"
    require_relative "langchain/llm/hugging_face"
    require_relative "langchain/llm/openai"
    require_relative "langchain/llm/replicate"
  end
